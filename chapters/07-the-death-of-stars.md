...
**Exercise 1.** Stellar mass determines stellar fate: low-mass stars (<8 M_☉) become white dwarfs; massive stars (>8 M_☉) explode as supernovae. Prompt an LLM: "Why is 8 solar masses the approximate dividing line? Walk through what happens during late stellar evolution: low-mass stars cannot reach the high core temperatures needed for advanced fusion stages (carbon, oxygen, silicon burning). Without these stages, the core ends as electron-degenerate carbon-oxygen white dwarf." Evaluate whether the response correctly identifies the temperature-mass connection — and specifically, that ~8 M_☉ is the threshold for igniting carbon burning, beyond which the more massive stars proceed through advanced burning stages until they reach iron, where fusion no longer releases energy.
...
```
Who is Jocelyn Bell Burnell, and how does her discovery of pulsars connect to the stellar death we covered in this chapter? Keep it to three paragraphs. End with the single most surprising thing about her career or ideas.
```
